...
params.ftsSerialNumbers={'SN311', 'SN315'}; % should be defined in the same order of ftNames
...
%
% Experimental assumption: The sketch for PRO.02 should be placed to have 
