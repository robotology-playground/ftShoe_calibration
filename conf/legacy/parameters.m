...
params.staticOffsetExp = 'analog_o_00000';
...
% For front ftSensor Os_amti = (0, 0.199, 0,01)
% For rear ftSensor  Os_amti = (0, 0.170, 0.01)

Ofts_amti_front = [0, 0.199, 0.01];
Ofts_amti_rear = [0. 0.170, 0.01];
